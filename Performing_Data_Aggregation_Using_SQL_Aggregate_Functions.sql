...
SELECT *
FROM employees
HAVING hire_date >= '2000-01-01'; --This doesn't work because you need group-by clause
									-- to use HAVING keyword
...
SELECT SUM(*)
FROM salaries; --Error because you need a numeric column to add
